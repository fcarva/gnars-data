# Gnars DAO Dune Queries (Copy/Paste)

Cada bloco abaixo deve ser criado como **uma query separada** no Dune.
...
## IDs para preencher depois

No final, me envie os IDs para eu salvar em `data/sources.json`:

```json
{
  "dune_queries": {
    "treasury_balance_over_time": 6881668,
        "auction_revenue_all_time": 6881718,
        "proposal_spend_by_category": 6881723,
        "holders_over_time": 6881732,
        "vote_participation": 6881740,
        "dashboard_url": "https://dune.com/0xsatori/gnarsv2"
  }
}
```
